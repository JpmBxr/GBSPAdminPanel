    ...
    <v-card class="mb-10">
      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-row dense class="mt-5 px-4">
            <v-col cols="6">
              <v-autocomplete
                v-model="book_test_current_status"
                :items="statusItems"
                dense
                small-chips
                label="Booking Test Status"
                item-text="text"
                item-value="value"
              >
                <template>
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.book_test_current_status="{ item }">
            <v-select
              v-model="item.book_test_current_status"
              :items="statusItems"
