    ...
    <v-card class="mb-10">
      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-row dense class="mt-5 px-4">
            <v-col cols="6">
              <v-autocomplete
                v-model="book_medicine_current_status"
                :items="statusItems"
                dense
                small-chips
                label="Booking Medicine Status"
                item-text="text"
                item-value="value"
              >
                <template>
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:top>
            <v-toolbar flat>
              <v-text-field
                ...
                v-model="searchText"
                label="Search"
                placeholder="Enter Name, Mobile and press ENTER to search"
          ...
          <template v-slot:item.book_medicine_current_status="{ item }">
            <v-select
              v-model="item.book_medicine_current_status"
              :items="statusItems"
...
<script>
import { bookMedicine } from "./bookMedicine";
