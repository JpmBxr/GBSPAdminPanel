      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-row dense class="mt-5 px-4">
            <v-col cols="4">
              <v-menu
                ref="menu_video_booking_date"
                v-model="menu_video_booking_date"
                :close-on-content-click="false"
                :return-value.sync="video_booking_date"
              ...
              >
                ...
                <v-date-picker v-model="video_booking_date" no-title scrollable>
                  <v-spacer></v-spacer>
                  <v-btn
                    text
                    color="primary"
                    @click="menu_video_booking_date = false"
                  >
                    Cancel
                  </v-btn>
                  <v-btn
                    ...
                    color="primary"
                    @click="
                      $refs.menu_video_booking_date.save(video_booking_date)
                    "
                  >
                    OK
                  </v-btn>
...
<script>
import { upcomingVideoBookingDetails } from "../upcomingVideoBookingDetails/upcomingVideoBookingDetails";
export default upcomingVideoBookingDetails;
</script>
