    ...
    <v-card class="mb-10">
      ...
      <transition name="fade" mode="out-in">
        ...
        >
          ...
          <template v-slot:item.View_Clinic_Booking="{ item }">
            <v-btn
              color="blue-grey"
              class="ma-2 white--text"
              @click="viewClinicBooking(item)"
            >
              View OPD Booking
              <v-icon right dark> mdi-eye-check-outline </v-icon>
            </v-btn>
          </template>

          <template v-slot:item.View_Video_Booking="{ item }">
            <v-btn
              color="blue-grey"
              class="ma-2 white--text"
                @click="viewVideoBooking(item)"
            >
              View Video Booking
              <v-icon right dark> mdi-eye-check-outline </v-icon>
            </v-btn>
...
<script>
import { regPatient } from "../regPatient/regPatient";
