      ...
      <v-expand-transition>
        <div v-show="show">
          ...
          <v-row dense class="mt-5 px-4">
            ...
            <v-col cols="4">
              <v-autocomplete
                v-model="video_booking_is_active"
          ...
          <v-row dense class="mt-5 px-4">
            <v-col cols="4">
              <v-menu
                ref="menu_video_booking_from_date"
                v-model="menu_video_booking_from_date"
                :close-on-content-click="false"
                :return-value.sync="video_booking_from_date"
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    v-model="video_booking_from_date"
                    label="Booking From"
                ...
                >
                  ...
                  <v-btn
                    text
                    color="primary"
                    @click="menu_video_booking_from_date = false"
                  >
                    Cancel
                  </v-btn>
                  <v-btn
                    ...
                    color="primary"
                    @click="
                      $refs.menu_video_booking_from_date.save(
            ...
            <v-col cols="4">
              <v-menu
                ref="menu_video_booking_to_date"
                v-model="menu_video_booking_to_date"
                :close-on-content-click="false"
                :return-value.sync="video_booking_to_date"
                transition="scale-transition"
                offset-y
                min-width="auto"
              >
                ...
                >
                  ...
                  <v-btn
                    text
                    color="primary"
                    @click="menu_video_booking_to_date = false"
                  >
                    Cancel
                  </v-btn>
                  <v-btn
                    ...
                    color="primary"
                    @click="
                      $refs.menu_video_booking_to_date.save(
...
<script>
import { videoVisitClinicWise } from "../videoVisitClinicWise/videoVisitClinicWise";
export default videoVisitClinicWise;
</script>
