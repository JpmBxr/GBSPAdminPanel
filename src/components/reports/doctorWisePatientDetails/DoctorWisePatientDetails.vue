...
<script>
import { doctorWisePatientDetails } from "../doctorWisePatientDetails/doctorWisePatientDetails";
export default doctorWisePatientDetails;
</script>
